        ...
        <section className="curriculum-vitae-section education-section mb-5">
            ...
            <div className="curriculum-vitae-section-content">
                <ul className="list-unstyled">
                    {EDUCATION_LIST && EDUCATION_LIST.length && EDUCATION_LIST.map(item =>
                        <li className="mb-2" key={item.DURATION}>
                            <div className="curriculum-vitae-degree font-weight-bold">{item.DEGREE}</div>
                            <div className="curriculum-vitae-degree-org">{item.UNIVERSITY_NAME}</div>
                            <div className="curriculum-vitae-degree-time">{item.DURATION}</div>
                        </li>)}
                </ul>
            </div>
        </section>
