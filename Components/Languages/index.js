        ...
        <section className="curriculum-vitae-section language-section mb-5">
            ...
            <div className="curriculum-vitae-section-content">
                <ul className="list-unstyled curriculum-vitae-lang-list">
                    {LANGUAGE_LIST.map(item => <li className="mb-2" key={item.NAME}><span className="curriculum-vitae-lang-name font-weight-bold">{item.NAME}</span> <small className="text-muted font-weight-normal">({item.LEVEL})</small></li>
                    )}
                </ul>
            </div>
        </section>
